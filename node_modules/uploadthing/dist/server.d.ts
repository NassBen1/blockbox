...
export { h as ActionType, d as AnyParams, A as AnyRuntime, D as DistributiveOmit, E as ErrorMessage, M as MaybePromise, c as MiddlewareFnArgs, S as Simplify, j as UTEvents, b as UnsetMarker, e as UploadBuilderDef, f as Uploader, V as VALID_ACTION_TYPES, a as inferEndpointInput, i as inferEndpointOutput, g as inferErrorShape, u as unsetMarker } from './types-b5a44cf1.js';
...
import { L as LogLevel, C as CreateBuilderOptions, R as RouterWithConfig } from './upload-builder-e4cab397.js';
...
/** @internal */
declare const INTERNAL_DO_NOT_USE_createRouteHandlerCore: <TRouter extends FileRouter>(opts: RouterWithConfig<TRouter>, adapter: string) => {
    GET: (request: Request | {
        request: Request;
    }) => Response;
...
export { FileRouter, INTERNAL_DO_NOT_USE_createRouteHandlerCore, ResponseWithCleanup, UTApi, UploadBuilder, createRouteHandler, createServerHandler, createUploadthing, extractRouterConfig };
