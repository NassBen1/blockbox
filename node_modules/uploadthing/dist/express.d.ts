...
declare const createRouteHandler: <TRouter extends FileRouter>(opts: RouterWithConfig<TRouter>) => Router;
/**
 * @deprecated Use {@link createRouteHandler} instead
 */
declare const createUploadthingExpressHandler: <TRouter extends FileRouter>(opts: RouterWithConfig<TRouter>) => Router;

export { FileRouter, createRouteHandler, createUploadthing, createUploadthingExpressHandler };
