...
} from "./chunk-J6PR442L.mjs";

// src/components/index.tsx
import { resolveMaybeUrlArg as resolveMaybeUrlArg3 } from "uploadthing/client";
...
import {
  ...
  resolveMaybeUrlArg as resolveMaybeUrlArg2,
...
function UploadDropzone(props) {
  ...
  const useUploadThing = INTERNAL_uploadthingHookGen({
    url: resolveMaybeUrlArg2($props.url)
  });
...
var generateUploadButton = (opts) => {
  const url = resolveMaybeUrlArg3(opts == null ? void 0 : opts.url);
  const TypedButton = (props) => /* @__PURE__ */ jsx5(UploadButton, { ...props, url });
  return TypedButton;
};
var generateUploadDropzone = (opts) => {
  const url = resolveMaybeUrlArg3(opts == null ? void 0 : opts.url);
  const TypedDropzone = (props) => /* @__PURE__ */ jsx5(UploadDropzone, { ...props, url });
  return TypedDropzone;
};
var generateUploader = (opts) => {
  const url = resolveMaybeUrlArg3(opts == null ? void 0 : opts.url);
  const TypedUploader = (props) => /* @__PURE__ */ jsx5(Uploader, { ...props, url });
...
// src/index.ts
import { useDropzone as useDropzone2 } from "@uploadthing/dropzone/react";
export {
  UploadButton,
  UploadDropzone,
  Uploader,
