...
export type UseUploadthingProps<TRouter extends FileRouter, TEndpoint extends keyof TRouter> = {
...
export type UploadthingComponentProps<TRouter extends FileRouter, TEndpoint extends keyof TRouter> = UseUploadthingProps<TRouter, TEndpoint> & {
    endpoint: TEndpoint;
    /**
     * URL to the UploadThing API endpoint
